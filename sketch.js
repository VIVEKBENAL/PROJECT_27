...
function preload () {
  ...
  backgroundIMG = loadImage("NEE.png");
...
function keyPressed() { 
	if (keyCode === UP_ARROW) 
  { Matter.Body.applyForce(bob1.body,bob1.body.position,{x:-100,y:-30}); } 
  

  if (keyCode === DOWN_ARROW) 
	{ Matter.Body.applyForce(bob1.body,bob1.body.position,{x:1,y:5}); 
} 
